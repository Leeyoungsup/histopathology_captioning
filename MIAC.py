...
encoder = AttentionMILModel(300,1280,Feature_Extractor).to(device)
...
for epoch in range(params['epochs']):
    ...
    if val_bleu_score/val_count>sum_loss:
        ...
        torch.save(encoder.state_dict(), '../../model/efficientnetv2_s_and_transformer_encoder_check.pth')
        torch.save(decoder.state_dict(), '../../model/efficientnetv2_s_and_transformer_decoder_check.pth')